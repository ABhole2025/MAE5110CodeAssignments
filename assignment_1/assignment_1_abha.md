...
![Initial conditions (20^\circ,0)](20_0_angle_time plot.png)
![Initial conditions (-40^\circ,0)](slope_40_minus40_0_angle_time.png)
...
![Initial conditions (10^\circ,0)](phase_10_0_plot.png)
...
(Rimless_Wheel_RoA_101x101_minuspi_to_pi.png)
...
(Rimless Wheel RoA 360x360 0to2pi 0to18.png)
...
![Return map](Rimless Wheel Return Map.png)
...
![Slope sweep for Floquet Multiplier](Floquet vs Slope.png)
...
![Slope sweep for RoA](RoA Slope Sweep.png)
...
![Number of spokes sweep for Floquet Multiplier](Floquet vs Number of Spokes.png)
...
![Number of spokes sweep for RoA](RoA Spoke Sweep.png)
